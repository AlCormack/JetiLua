 --[[
    ...
    Ver 1.4 - 21st Jul 2019 - Build in start audio
...
local function init()
	...
	startAudio = "/Apps/MHSFADrag/rdystdygo.wav"
...
MHSFAVersion = "1.4"
collectgarbage()
return {init=init, loop=loop, author="AlastairC", version="1.4", name="MHSFADrag"}
